...
collision.objectAdd(scene, gui)

const cameraFolder = gui.addFolder('Camera')
cameraFolder.close()
cameraFolder.add(camera.position, 'x', -100, 100, 0.001).name('positionX')
cameraFolder.add(camera.position, 'y', -100, 100, 0.001).name('positionY')
cameraFolder.add(camera.position, 'z', -100, 100, 0.001).name('positionZ')
cameraFolder.add(camera.position, 'x', -100, 100, 0.001).name('rotationX')
cameraFolder.add(camera.position, 'y', -100, 100, 0.001).name('rotationY')
cameraFolder.add(camera.position, 'z', -100, 100, 0.001).name('rotationZ')
