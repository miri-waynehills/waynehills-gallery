...
const screen1 = new THREE.PlaneGeometry(3.8,4);
const content1Screen = new THREE.Mesh(screen1, content1Material);
content1Screen.position.set(-12.3,3.1,-19.57)
...
content3Screen.position.set(-18.2,3.1,-19.57)
...
content4Screen.position.set(-6,3.1,-19.57)
...
content5Screen.rotation.set(0, -Math.PI*0.5, 0)
content5Screen.position.set(6.07,3.1,13.94)
...
content6Screen.position.set(3.7,3.1,18.17)
...
content7Screen.rotation.set(0, -Math.PI*0.5, 0)
content7Screen.position.set(6.07,3.1,-15.75)
...
imageContent1.position.set(-29.5, 3.1, -15.1)
